...
# ── Title ────────────────────────────────────────────────────────────────────
txt(XC, cur, 'TripMind — System Architecture', size=18.5, color=TEXT, weight='bold')
...
cards = [
    ...
    (M_CURR, 'tripmind-curriculum', '5,000 pairs → 500 traces', ('2-stage · lr decay 4×', 'loss 0.241 / 0.505')),
]
